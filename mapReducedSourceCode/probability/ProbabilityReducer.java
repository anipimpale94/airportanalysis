...
public class ProbabilityReducer extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
  ...
  public void reduce(Text word, Iterable<DoubleWritable> values, Context con) throws IOException, InterruptedException {
    ...
    double probability = lateEventTotal/eventTotal*100;
    map.put(mainWord, probability);
  }
  ...
  protected void cleanup(Context context) throws IOException, InterruptedException {
    ...
    context.write(new Text("Lowest Probability of getting Late"), null);
    ...
    context.write(new Text("Highest Probability of getting Late"), null);
    for(int k = 0; k < 3; k++){
