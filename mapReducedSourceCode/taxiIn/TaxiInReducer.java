...
public class TaxiInReducer extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
  ...
  protected void cleanup(Context context) throws IOException, InterruptedException {
    ...
    context.write(new Text("Lowest Average of Taxi In Time"), null);
    ...
    context.write(new Text("Highest Average of Taxi In Time"), null);
    for(int k = 0; k < 3; k++){
